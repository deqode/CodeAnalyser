...
var file_proto_orm_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x46, 0x6c, 0x6f, 0x61, 0x74, 0x42, 0x07, 0x5a,
...
func file_proto_orm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_orm_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
