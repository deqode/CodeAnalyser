...
const protoPath = [
  __dirname + "../../../../../../protos/plugin/library.proto",
  __dirname + "../../../../../../protos/helpers/common.proto",
  __dirname + "../../../../../../protos/output/languageSpecific/libraries.proto",
];
...
server.addService(protoFile.proto.Library.service, methods);
