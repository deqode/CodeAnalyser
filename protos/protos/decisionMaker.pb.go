...
type Commands struct {
	...
	MigrationCommands []*MigrationCommandsOutput `protobuf:"bytes,4,rep,name=MigrationCommands,proto3" json:"MigrationCommands,omitempty"` //   todo:   DetectAdHocScripts
}
...
var file_protos_outputs_decisionMaker_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x73, 0x42, 0x0a,
...
var file_protos_outputs_decisionMaker_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_protos_outputs_decisionMaker_proto_goTypes = []interface{}{
	...
	(*EnvOutput)(nil),                  // 3: EnvOutput
	(*FrameworkOutput)(nil),            // 4: FrameworkOutput
	(*DBOutput)(nil),                   // 5: DBOutput
	(*OrmOutput)(nil),                  // 6: OrmOutput
	(*DependenciesOutput)(nil),         // 7: DependenciesOutput
	(*LibrariesOutput)(nil),            // 8: LibrariesOutput
	(*StaticAssetsOutput)(nil),         // 9: StaticAssetsOutput
	(*StackOutput)(nil),                // 10: StackOutput
	(*AppserverOutput)(nil),            // 11: AppserverOutput
	(*BuildDirectoryOutput)(nil),       // 12: BuildDirectoryOutput
	(*ProcFileOutput)(nil),             // 13: ProcFileOutput
	(*MakefileOutput)(nil),             // 14: MakefileOutput
	(*DockerFileOutput)(nil),           // 15: DockerFileOutput
	(*DockerComposeFileOutput)(nil),    // 16: DockerComposeFileOutput
	(*BuildCommandsOutput)(nil),        // 17: BuildCommandsOutput
	(*StartUpCommandsOutput)(nil),      // 18: StartUpCommandsOutput
	(*SeedCommandsOutput)(nil),         // 19: SeedCommandsOutput
	(*MigrationCommandsOutput)(nil),    // 20: MigrationCommandsOutput
}
var file_protos_outputs_decisionMaker_proto_depIdxs = []int32{
	3,  // 0: LanguageSpecificDetections.env:type_name -> EnvOutput
	...
	11, // 8: LanguageSpecificDetections.appserver:type_name -> AppserverOutput
	12, // 9: LanguageSpecificDetections.buildDirectory:type_name -> BuildDirectoryOutput
	2,  // 10: LanguageSpecificDetections.commands:type_name -> Commands
	13, // 11: GlobalDetections.procFile:type_name -> ProcFileOutput
	14, // 12: GlobalDetections.makefile:type_name -> MakefileOutput
	15, // 13: GlobalDetections.dockerFile:type_name -> DockerFileOutput
	16, // 14: GlobalDetections.dockerComposeFile:type_name -> DockerComposeFileOutput
	17, // 15: Commands.buildCommands:type_name -> BuildCommandsOutput
	18, // 16: Commands.startUpCommands:type_name -> StartUpCommandsOutput
	19, // 17: Commands.seedCommands:type_name -> SeedCommandsOutput
	20, // 18: Commands.MigrationCommands:type_name -> MigrationCommandsOutput
