...
func (x *MakeFileOutput) GetError() *Error {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *MakeFileOutput) GetMakefile() *global.MakeFile {
	if x != nil {
		return x.Makefile
	}
	return nil
...
var file_protos_plugin_makeFile_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x70, 0x0a, 0x0e, 0x4d, 0x61, 0x6b, 0x65, 0x46, 0x69,
	...
	0x6d, 0x61, 0x6b, 0x65, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x2e, 0x67,
	0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x2e, 0x4d, 0x61, 0x6b, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x08,
	0x6d, 0x61, 0x6b, 0x65, 0x66, 0x69, 0x6c, 0x65, 0x32, 0x3f, 0x0a, 0x08, 0x4d, 0x61, 0x6b, 0x65,
	...
	0x75, 0x74, 0x1a, 0x15, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4d, 0x61, 0x6b, 0x65, 0x46,
...
var file_protos_plugin_makeFile_proto_goTypes = []interface{}{
	(*MakeFileOutput)(nil),  // 0: proto.MakeFileOutput
	(*Error)(nil),           // 1: proto.Error
	(*global.MakeFile)(nil), // 2: protos.output.global.MakeFile
	(*StringInput)(nil),     // 3: proto.StringInput
}
var file_protos_plugin_makeFile_proto_depIdxs = []int32{
	1, // 0: proto.MakeFileOutput.error:type_name -> proto.Error
	2, // 1: proto.MakeFileOutput.makefile:type_name -> protos.output.global.MakeFile
	3, // 2: proto.MakeFile.Detect:input_type -> proto.StringInput
	0, // 3: proto.MakeFile.Detect:output_type -> proto.MakeFileOutput
