...
type TestCaseCommandsClient interface {
	Detect(ctx context.Context, in *helpers.Input, opts ...grpc.CallOption) (*languageSpecific.TestCasesCommand, error)
}
...
func (c *testCaseCommandsClient) Detect(ctx context.Context, in *helpers.Input, opts ...grpc.CallOption) (*languageSpecific.TestCasesCommand, error) {
	out := new(languageSpecific.TestCasesCommand)
...
type TestCaseCommandsServer interface {
	Detect(context.Context, *helpers.Input) (*languageSpecific.TestCasesCommand, error)
}
...
func (UnimplementedTestCaseCommandsServer) Detect(context.Context, *helpers.Input) (*languageSpecific.TestCasesCommand, error) {
...
func _TestCaseCommands_Detect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestCaseCommandsServer).Detect(ctx, req.(*helpers.Input))
	}
...
var TestCaseCommands_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protos/plugin/testCaseCommands.proto",
}
