...
func (x *DockerComposeFileOutput) GetFilePath() string {
	if x != nil {
		return x.FilePath
	}
	return ""
...
func (x *DockerComposeFileOutput) GetCommands() []*Command {
	if x != nil {
		return x.Commands
	}
	return nil
...
var file_protos_output_global_dockercompose_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x84, 0x01, 0x0a, 0x17, 0x44, 0x6f, 0x63, 0x6b, 0x65, 0x72, 0x43,
	...
	0x75, 0x73, 0x65, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x50, 0x61, 0x74, 0x68,
	...
	0x64, 0x52, 0x08, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x73, 0x42, 0x27, 0x5a, 0x25, 0x63,
...
var file_protos_output_global_dockercompose_proto_depIdxs = []int32{
	1, // 0: protos.output.global.DockerComposeFileOutput.commands:type_name -> protos.output.global.Command
