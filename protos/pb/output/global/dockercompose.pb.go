...
func (x *DockerComposeFile) GetFilePath() string {
	if x != nil {
		return x.FilePath
	}
	return ""
...
func (x *DockerComposeFile) GetCommands() []*Command {
	if x != nil {
		return x.Commands
	}
	return nil
...
var file_protos_output_global_dockercompose_proto_rawDesc = []byte{
	...
	0x72, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x22, 0x6a, 0x0a,
	0x11, 0x44, 0x6f, 0x63, 0x6b, 0x65, 0x72, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x65, 0x46, 0x69,
	0x6c, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x50, 0x61, 0x74, 0x68, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x50, 0x61, 0x74, 0x68, 0x12, 0x39,
	...
	0x08, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x73, 0x42, 0x27, 0x5a, 0x25, 0x63, 0x6f, 0x64,
...
var file_protos_output_global_dockercompose_proto_depIdxs = []int32{
	...
	2, // 1: protos.output.global.DockerComposeFile.commands:type_name -> protos.output.global.Command
