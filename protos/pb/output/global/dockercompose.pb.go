...
func (x *DockerCompose) GetCommands() []*Command {
	if x != nil {
		return x.Commands
	}
	return nil
...
var file_protos_output_global_dockercompose_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7a, 0x0a, 0x0d, 0x44, 0x6f, 0x63, 0x6b, 0x65, 0x72, 0x43, 0x6f,
	0x6d, 0x70, 0x6f, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x64, 0x18, 0x01, 0x20,
...
var file_protos_output_global_dockercompose_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_protos_output_global_dockercompose_proto_goTypes = []interface{}{
	(*DockerCompose)(nil), // 0: protos.output.global.DockerCompose
	(*Command)(nil),       // 1: protos.output.global.Command
}
var file_protos_output_global_dockercompose_proto_depIdxs = []int32{
	1, // 0: protos.output.global.DockerCompose.commands:type_name -> protos.output.global.Command
